<script lang="ts">
  ...
  import CursorAnnotation from "./CursorAnnotation.svelte";
...
{#if currentTurn?.screenshot}
  <div class="flex h-full justify-center overflow-hidden">
    <div
      ...
      style="aspect-ratio: {screenDimensions.width}/{screenDimensions.height}"
    >
      <img
      ...
      <CursorAnnotation {screenDimensions} />
    </div>
  </div>
