...
<div class="flex items-center gap-2 pb-2">
  ...
  <button
    ...
    type="button"
    disabled={!hasPrev}
    class="flex h-6 w-6 items-center justify-center rounded text-neutral-600 hover:bg-neutral-200 dark:text-neutral-400 dark:hover:bg-neutral-700 disabled:opacity-50 disabled:cursor-not-allowed"
  ...
  <div class="flex items-center gap-1 ml-2">
    ...
    <select
      ...
      class="text-xs bg-transparent border border-neutral-300 dark:border-neutral-600 rounded px-1 py-0.5 text-neutral-700 dark:text-neutral-300"
    >
